...
export default class YourSafety extends React.Component {
  ...
  _renderContent() {
    let list = [
      { title: 'Your rights & Safety', image: Images.safe_migrant, screenName: 'ImageViewScreen', imageList: 'visas', fileName: '', w: 34, h: 45 },
      { title: 'Safety planning', image: Images.safe_migrant, screenName: 'ImageViewScreen', imageList: 'worker_cards', fileName: '', w: 34, h: 45 },
      { title: 'Videos', image: Images.safe_migrant, screenName: 'ImageViewScreen', imageList: 'worker_cards', fileName: '', w: 34, h: 45 },
    ];
